...
public class ExpandableDailyHrAccountAdapter extends BaseExpandableListAdapter {
    ...
    public ExpandableDailyHrAccountAdapter(Context context, List<String> listDataHeader, HashMap<String, ArrayList<DailyAccountModel.FinalArray>> listDataChild, String viewstatus) {
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        txt_bb = convertView.findViewById(R.id.txt_bb);
        txt_petty_cash = convertView.findViewById(R.id.txt_petty_cash);
        txt_expenses = convertView.findViewById(R.id.txt_expenses);
        txt_fees_rec = convertView.findViewById(R.id.txt_fees_rec);
        txt_deposited = convertView.findViewById(R.id.txt_deposited);
