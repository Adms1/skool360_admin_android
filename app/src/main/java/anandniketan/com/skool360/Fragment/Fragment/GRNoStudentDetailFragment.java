...
import anandniketan.com.skool360.Adapter.ExpandableListAdapterGRstudentdetail;
...
import anandniketan.com.skool360.databinding.FragmentGrnoStudentDetailBinding;
...
//                }
    ...
    private void callStaffApi() {
        ...
        ApiHandler.getApiService().getStudentFullDetail(getGRRegisterDetail(), PrefUtils.getInstance(getActivity()).getStringValue("LocationID", "0"), new retrofit.Callback<StudentAttendanceModel>() {
