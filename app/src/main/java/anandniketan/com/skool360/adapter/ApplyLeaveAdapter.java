...
public class ApplyLeaveAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        TextView leavedate, approvedate, approvedays, approveby, reason, appdate, appby;
        ...
        appby = convertView.findViewById(R.id.tvApproveby);
        appdate = convertView.findViewById(R.id.tvApprovedate);
...
//        annousID = childData.get(childPosition).getPKAnnouncmentID();
        ...
        if (childData.get(childPosition).getStatus().equalsIgnoreCase("Pending")) {
            ...
            appby.setText(R.string.approve_by);
            appdate.setText(R.string.approve_date);
            ...
            llReason.setVisibility(View.VISIBLE);
            llBottom.setVisibility(View.GONE);
            appby.setText(R.string.reject_by);
            appdate.setText(R.string.reject_date);
        }
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (deletestatus.equalsIgnoreCase("true")) {
                    DialogUtils.createConfirmDialog(_context, R.string.delete, R.string.delete_leave_confirm_msg, "OK", "Cancel", new DialogInterface.OnClickListener() {
